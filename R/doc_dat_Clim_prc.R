#' Values of climatic variable for each year per study in the PRC dataset
#'
#' A dataset containing yearly values of climatic variables (temperature and precipiation)
#' for each study. Other attributes of the data represent study-specific meta-data.
#'
#' @name dat_Clim_prc
#' @docType data
#' @format A data frame with 14432 rows and 31 columns:
#' \describe{
