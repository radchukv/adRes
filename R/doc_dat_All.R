#' Unique values of selection differentials, traits and climatic variables for each year per study
#'
#' A dataset containing yearly selection values, yearly trait values
#' and yearly climatic values for each study (only unique studies retained).
#' Other attributes of the data represent study-specific meta-data.
#'
#' @name dat_All
#' @docType data
#' @format A data frame with 2333 rows and 44 columns:
#' \describe{
...
#' \item{ScaledTrait}{Scaled trait values for comparison among studies}
#' \item{ScaledSE}{Scaled standard error of the trait values for comparison among studies}
#' \item{ScaledPop}{Scaled values of population abundance for comparison among studies}
