#' Trait values per year per study in the PRCS dataset
#'
#' A dataset containing yearly trait values for each study.
#' This dataset contains only studies that also have selection data,
...
#' @name dat_Trait
#' @docType data
#' @format A data frame with 1276 rows and 44 columns:
#' \describe{
